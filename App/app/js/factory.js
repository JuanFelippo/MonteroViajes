...
factory('ContractService', function($http) {
    return {
        read: function(id) {
            return $http.get(options.api.base_url + '/contracts/' + id);
        },
        
        findAll: function() {
            return $http.get(options.api.base_url + '/contracts');
        },

        delete: function(id) {
            return $http.delete(options.api.base_url + '/contracts/' + id);
        },

        create: function(contract) {
            return $http.post(options.api.base_url + '/contracts', {'contract': contract});
        },
        ...
        attach: function(file){
            ...
            return $http.post(options.api.base_url + '/contracts/attachment', fd, {
        ...
        update: function(contract) {
            return $http.put(options.api.base_url + '/contracts', {'contract': contract});
        },

        relatedData: function() {
            return $http.get(options.api.base_url + '/relateddata');
        }
    };
}).
factory('AuthenticationService', ['$http', '$window', function($http, $window){
    ...
    auth.saveToken = function (token){
       $window.localStorage['montero-sys-token'] = token;
    };
    auth.getToken = function (){
      return $window.localStorage['montero-sys-token'];
    };  
    ...
    auth.logIn = function(user){
       return $http.post(options.api.base_url +'/users/login', user).success(function(data){
         auth.saveToken(data.token);
       });
    };
    auth.logOut = function(){
       $window.localStorage.removeItem('montero-sys-token');
    };
    return auth;
}]).
